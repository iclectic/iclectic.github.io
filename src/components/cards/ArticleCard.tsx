...
export default function ArticleCard({
  ...
  return (
    <Link
      href={href}
      className="group block rounded-xl border border-border bg-background p-6 transition-colors hover:border-accent/60 dark:border-border-dark dark:bg-background-dark"
    >
      {image ? (
      ...
      <h3 className="mt-4 font-display text-h3 text-foreground transition-colors group-hover:text-accent dark:text-foreground-dark">
        {title}
      </h3>
